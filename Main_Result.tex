...
\section{Conclusions}
The stochastic stability anslysis and $l_{2}$-gain optimisation problems for a class of discrete-time nonlinear Markov systems with asynchronous controller have been discussed in this paper.
