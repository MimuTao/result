...
M_Matrix = [ 0.4 0.6; 0.3 0.7];% M_Matrix = [0.4 0.6; 0 1];
% M_Matrix = [1 0; 0 1];
...
% result_k_1 = dec2mat(lmisys,bpot,K{1})
% result_k_2 = dec2mat(lmisys,bpot,K{2})
% result_g_1 = dec2mat(lmisys,bpot,G{1})
% result_g_2 = dec2mat(lmisys,bpot,G{2})
